...
public partial class GrammarBaseListener : IGrammarListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterConst_and_var([NotNull] GrammarParser.Const_and_varContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="GrammarParser.const_and_var"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitConst_and_var([NotNull] GrammarParser.Const_and_varContext context) { }
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterDef_function([NotNull] GrammarParser.Def_functionContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="GrammarParser.def_function"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitDef_function([NotNull] GrammarParser.Def_functionContext context) { }
