...
public interface IGrammarVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitConst_and_var([NotNull] GrammarParser.Const_and_varContext context);
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitDef_function([NotNull] GrammarParser.Def_functionContext context);
